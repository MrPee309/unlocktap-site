  ...
  return (
    <nav style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'12px 16px',background:'#fff',borderBottom:'1px solid #eee'}}>
      <div style={{display:'flex',alignItems:'center',gap:8}}>
        ...
        <span style={{marginLeft:10,fontSize:12,color:'#6b7280'}}>DEBUG-NAV</span>
      </div>
      <div style={{display:'flex',alignItems:'center',gap:16}}>
        ...
        <div style={{position:'relative'}}>
          ...
          {open && (
            <div style={{position:'absolute',right:0,top:'100%',background:'#fff',border:'1px solid #e5e7eb',borderRadius:8,boxShadow:'0 8px 24px rgba(0,0,0,0.12)',minWidth:180,overflow:'hidden',zIndex:50}}>
